...
1...9 - select fleet with match number, if exists;
...
In fleet create mode:
Space on object - add object in fleet;
Shift + Space on object - create fleet;
Shift + Space on empty cell field - finish fleet create mode;
